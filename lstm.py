...
# Create Dataframe (df) where each row has N_TIMESTEPS prices of the underlying, ordered 
    # by date, in descending order. From one row to the next each price is 
    # replaced by the one observed in the next date.

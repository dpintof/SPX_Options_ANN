...
call = pd.read_csv("bsm_call.csv")
put = pd.read_csv("bsm_put.csv")
...
line1 = error_metrics(call.Average_Price, call.BSM_Prediction)
line2 = error_metrics(put.Average_Price, put.BSM_Prediction)
